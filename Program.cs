    ...
    internal class Program
    {
        static void Main(string[] args)
        {
            List<ProductReview> list = new List<ProductReview>()        //UC1
            {
                ...
                new ProductReview() { ProductId = 20, UserId = 11, IsLike = true, Review = "nice", Rating = 90 },
                ...
                new ProductReview() { ProductId = 23, UserId = 18, IsLike = true, Review = "nice", Rating = 90 },
                ...
                new ProductReview() { ProductId = 22, UserId = 25, IsLike = true, Review = "nice", Rating = 90 }
            };
